...
import { Budget } from '../supabase/types';
...
interface BudgetState {
  ...
  // Actions
  fetchBudgets: (userId: string, options?: any) => Promise<void>;
...
export const useBudgetStore = create<BudgetState>((set, get) => ({
  ...
  fetchBudgets: async (userId, options) => {
    try {
      ...
      set({ 
        error: error.message || 'Gagal memuat anggaran. Silakan coba lagi.',
        isLoading: false,
      });
    }
  },
  ...
  addBudget: async (budget) => {
    try {
      ...
      set({ 
        error: error.message || 'Gagal menambahkan anggaran. Silakan coba lagi.',
        isLoading: false,
      });
    }
  },
  ...
  updateBudget: async (id, updates) => {
    try {
      ...
      set({ 
        error: error.message || 'Gagal memperbarui anggaran. Silakan coba lagi.',
        isLoading: false,
      });
    }
  },
  ...
  deleteBudget: async (id) => {
    try {
      ...
      set({ 
        error: error.message || 'Gagal menghapus anggaran. Silakan coba lagi.',
        isLoading: false,
      });
    }
  },

module.exports = {
  expo: {
    ...
    android: {
      ...
      package: "com.batarahotdo.budgetwise",
    ...
    plugins: [
      ...
      [
        ...
        {
          photosPermission:
            "Aplikasi memerlukan akses ke galeri foto Anda untuk memilih gambar.",
          cameraPermission:
            "Aplikasi memerlukan akses ke kamera Anda untuk mengambil foto.",
        },
      ],
      ["expo-file-system", {}],
      ["expo-sensors", {}],
